...
policy_data <- read_csv("impic2016.csv") %>%
  select(cntry, cntryID, year, AvgS_a04, AvgS_c03, AvgS_d03_1, AvgS_e05, AvgS_e04, AvgS_ImmPol) %>%
...
ggplot(all_data, aes(x = largest_group, y = AvgS_ImmPol, color = year)) + 
  geom_point() +
  scale_y_continuous() + 
  theme_light() 
  # theme(axis.text.x = element_text(angle = 90, hjust = 1))

fit = lm(AvgS_ImmPol ~ largest_group, all_data)
summary(fit)
